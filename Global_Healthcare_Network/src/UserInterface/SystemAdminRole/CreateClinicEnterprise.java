 ...
 * @author Krunal Nisar
 */
public class CreateClinicEnterprise extends javax.swing.JPanel {
    ...
    EcoSystem system;
    public CreateClinicEnterprise(JPanel userProcessContainer , EcoSystem system) {
        initComponents();
       ...
       public void populateEnterpriseTable()
    {
        ...
        for(Network network: system.getNetworkList())
        {
            ...
            for(City city : state.getCityList())
            {
                ...
                {
                if(enterprise.getEnterpriseType().equals(EnterpriseType.Clinic))
                {
...
//    
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clinic Name", "Network", "State", "City"
            }
        ) {
        ...
        jLabel6.setText("    Manage Clinic Enterprise ");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
       ...
       {
        Enterprise enterprise= city.getEnterpriseDir().createAndAddEnterprise(name, EnterpriseType.Clinic);
        populateEnterpriseTable();
       }
       else
       {
