 ...
 * @author Krunal Nisar
 */
public class CreateHospitalEnterprise extends javax.swing.JPanel {
    ...
    EcoSystem system;
    public CreateHospitalEnterprise(JPanel userProcessContainer , EcoSystem system) {
        initComponents();
...
//    
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Hospital Name", "Network", "State", "City"
            }
        ) {
        ...
        jLabel6.setText("    Manage Hospital Enterprise ");
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
       ...
       {
      Enterprise enterprise= city.getEnterpriseDir().createAndAddEnterprise(name, EnterpriseType.Hospital);
        populateEnterpriseTable();;
       }
       else
       {
