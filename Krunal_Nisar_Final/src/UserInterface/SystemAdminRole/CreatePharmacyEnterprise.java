 ...
 * @author Krunal Nisar
 */
public class CreatePharmacyEnterprise extends javax.swing.JPanel {
    ...
    EcoSystem system;
    public CreatePharmacyEnterprise(JPanel userProcessContainer , EcoSystem system) {
        initComponents();
       ...
       public void populateEnterpriseTable()
    {
        ...
        for(Network network: system.getNetworkList())
        {
            ...
            for(City city : state.getCityList())
            {
                ...
                {
                if(enterprise.getEnterpriseType().equals(EnterpriseType.Pharmacy))
                {
...
//    
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pharmacy Name", "Network", "State", "City"
            }
        ) {
        ...
        jLabel6.setText("    Manage Pharmacy Enterprise ");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(networkJComboBox, 0, 105, Short.MAX_VALUE))))
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
       ...
       {
      Enterprise enterprise= city.getEnterpriseDir().createAndAddEnterprise(name, EnterpriseType.Pharmacy);
        populateEnterpriseTable();
       }
       else
       {
